        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden
            ...
            <div class="flex items-center justify-between px-6 py-4
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        <h3 class="text-white font-semibold text-sm tracking-wide">Tambah Semester</h3>
                        <p class="text-blue-200 text-[11px]">Isi data semester baru</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           class="w-full rounded-lg border px-3 py-2.5 text-sm text-slate-700
                                  ...
                                  transition
                                  @error('nama_semester') border-red-400 bg-red-50 @else border-slate-200 @enderror">
                    @error('nama_semester')
                ...
                <div>
                    ...
                    <select name="id_tahun_ajaran"
                            class="w-full rounded-lg border px-3 py-2.5 text-sm text-slate-700
                                   focus:outline-none focus:ring-2 focus:ring-[#1B3A6B]/30 focus:border-[#1B3A6B]
                                   transition
                                   @error('id_tahun_ajaran') border-red-400 bg-red-50 @else border-slate-200 @enderror">
                ...
                <div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox"
                               ...
                               class="rounded border-slate-300 text-[#1B3A6B] focus:ring-[#1B3A6B]/30">
                        <span class="text-xs font-bold text-slate-500 uppercase tracking-widest">Semester Aktif</span>
                    </label>
                    @error('is_aktif')
                        <p class="mt-1.5 flex items-center gap-1 text-xs text-red-500">
                            <svg class="w-3 h-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
