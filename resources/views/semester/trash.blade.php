                    ...
                    <form method="GET" action="{{ route('semester.trash') }}" class="flex items-center gap-2 w-full">
                        ...
                        <select name="tahun_ajaran"
                            ...
                            @foreach ($tahunAjarans as $ta)
                                <option value="{{ $ta->id }}"
                                    {{ (string) request('tahun_ajaran') === (string) $ta->id ? 'selected' : '' }}>
                                    {{ $ta->nama_tahun }}</option>
                            @endforeach
                        </select>
                                ...
                                <tr class="hover:bg-red-50/30 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            {{-- Force Delete --}}
                                            <form action="{{ route('semester.force-delete', $semester) }}"
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            @else
                                                <p class="text-gray-300 text-xs">Tidak ada data semester yang dihapus
                                                    sementara</p>
                                            @endif
                                        </div>
                                    </td>
