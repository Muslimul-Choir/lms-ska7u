    ...
    <div class="py-8 bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5">
            ...
            <nav class="flex items-center gap-1.5 text-xs text-slate-400 font-medium tracking-wide">
                ...
                <span class="text-slate-300">/</span>
                <a href="{{ route('tingkatan.index') }}" class="hover:text-[#1B3A6B] transition">Tingkatan</a>
                <span class="text-slate-300">/</span>
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-6 py-4
                    ...
                    <div>
                        <h3 class="text-white font-semibold text-sm tracking-wide">Data Tingkatan Terhapus</h3>
                ...
                @if ($tingkatans->hasPages())
                    <div class="px-6 py-4 border-t border-slate-100 bg-slate-50 flex items-center justify-between gap-4">
                        <p class="text-xs text-slate-500">
                            Menampilkan
                            <span class="font-semibold text-slate-700">{{ $tingkatans->firstItem() }}–{{ $tingkatans->lastItem() }}</span>
                            dari
                            <span class="font-semibold text-slate-700">{{ $tingkatans->total() }}</span>
                            entri
                        </p>
                        {{ $tingkatans->links() }}
                    </div>
