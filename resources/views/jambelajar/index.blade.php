    ...
    <div class="py-8 bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5">
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                {{-- Card Header --}}
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-6 py-4 border-b border-slate-100 bg-gradient-to-r from-[#0F2145] to-[#1B3A6B]">
                    <div>
                        <h3 class="text-white font-semibold text-sm tracking-wide">Daftar Jam Belajar</h3>
                        <p class="text-blue-200 text-xs mt-0.5">Kelola data waktu belajar per tingkatan</p>
                    </div>
                    ...
                    <table class="min-w-full text-sm border-collapse">
                        <thead>
                            <tr class="bg-slate-50 border-b border-slate-200">
                                <th class="px-6 py-3 text-left text-[11px] font-bold text-slate-500 uppercase tracking-widest w-44 whitespace-nowrap">
                                    Tingkatan
                                </th>
                                @foreach($jamKe as $ke => $label)
                                    <th class="px-4 py-3 text-center text-[11px] font-bold text-slate-500 uppercase tracking-widest whitespace-nowrap border-l border-slate-100">
                                        {{ $label }}
                                    </th>
                                @endforeach
                            </tr>
