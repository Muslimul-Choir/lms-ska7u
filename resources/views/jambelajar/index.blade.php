<x-app-layout>
                        ...
                        <thead>
                            <tr class="bg-gray-50 border-b border-gray-200">
                                ...
                                @foreach ($jamKe as $ke => $label)
                                    <th
                                        class="px-4 py-3 text-center text-[11px] font-bold text-gray-500 uppercase border-l border-gray-100">
                                        {{ $label }}
                                    </th>
                                @endforeach
                            </tr>
    ...
    {{-- MODAL EDIT --}}
    <div id="modalEdit" class="fixed inset-0 z-[9999] hidden items-center justify-center">

        {{-- Overlay --}}
        <div id="overlayEdit" class="absolute inset-0 bg-black/50 backdrop-blur-sm"></div>
        ...
        <div class="relative z-10 w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gradient-to-r from-[#6B1A2B] to-[#2D0810] flex items-center justify-between">
                ...
                <button type="button" id="closeEdit" class="text-white text-xl">
                    ✕
                </button>
            </div>

            {{-- Form --}}
            <form id="formEdit" method="POST" class="p-6 space-y-5">
