<x-app-layout>
    ...
    <div class="py-8 bg-[#f0f4f8] min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5">
            ...
            {{-- Alert Success --}}
            @if (session('success'))
                <div role="alert" class="flex items-center justify-between px-4 py-3 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-lg text-sm shadow-sm" title="Berhasil disimpan">
