    ...
    <div class="bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto space-y-5">
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                {{-- Card Header --}}
                <div
                    class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-6 py-4
                        ...
                        <tbody class="divide-y divide-slate-100">
                            @forelse ($jamBelajars as $jamBelajar)
                                <tr class="hover:bg-red-50/40 transition group">
                                    ...
                                    {{-- Jam Selesai --}}
                                    <td
                                        class="px-6 py-4 text-slate-500 text-sm font-semibold line-through decoration-red-300">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            {{-- Restore --}}
                                            <form action="{{ route('jambelajar.restore', $jamBelajar->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit"
                                            ...
                                            {{-- Force Delete --}}
                                            <form action="{{ route('jambelajar.force-delete', $jamBelajar->id) }}"
                                                method="POST"
                ...
                @if ($jamBelajars->hasPages())
                    <div
                        ...
                        <p class="text-xs text-slate-500">
                            Menampilkan
                            <span
                                class="font-semibold text-slate-700">{{ $jamBelajars->firstItem() }}–{{ $jamBelajars->lastItem() }}</span>
                            dari
