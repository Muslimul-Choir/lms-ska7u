        ...
        <div class="bg-white rounded-[18px] shadow-[0_24px_60px_rgba(107,26,43,0.22),0_4px_16px_rgba(0,0,0,0.08)] overflow-hidden border border-[rgba(107,26,43,0.1)]">
            ...
            <div class="px-6 py-[18px] flex items-center justify-between relative overflow-hidden"
                ...
                <div class="flex items-center gap-3 relative">
                    ...
                    <div>
                        <h3 class="text-white font-bold text-[15px] m-0 mb-[2px]">Tambah Jam Belajar</h3>
                        <p class="text-[rgba(255,255,255,0.5)] text-[11px] m-0">Isi data jam belajar baru</p>
                    </div>
                </div>
            ...
            {{-- Body --}}
            <form action="{{ route('jambelajar.store') }}" id="createFormAction" method="POST" class="p-6 flex flex-col gap-[18px]">
                @csrf
                ...
                <div class="flex flex-col gap-[7px]">
                    ...
                    <div class="relative">
                        ...
                        <select name="id_tingkatan"
                            ...
                            {{ $errors->has('id_tingkatan') && old('_modal') === 'create' ? 'border-red-300 bg-red-50' : 'border-gray-200' }}">
                            <option value="">-- Pilih Tingkatan --</option>
                            @foreach($tingkatanList as $tingkatan)
                                <option value="{{ $tingkatan->id }}"
                                    {{ old('id_tingkatan') == $tingkatan->id && old('_modal') === 'create' ? 'selected' : '' }}>
                    ...
                    <div class="flex flex-col gap-[7px]">
                        ...
                        <div class="relative">
                            ...
                            <input type="time" name="jam_mulai" value="{{ old('jam_mulai') }}"
                                ...
                                {{ $errors->has('jam_mulai') && old('_modal') === 'create' ? 'border-red-300 bg-red-50' : 'border-gray-200' }}">
                        </div>
                        @if ($errors->has('jam_mulai') && old('_modal') === 'create')
                            <p class="flex items-center gap-1 text-xs text-red-600">
                                <svg class="w-3 h-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                    ...
                    <div class="flex flex-col gap-[7px]">
                        ...
                        <div class="relative">
                            ...
                            <input type="time" name="jam_selesai" value="{{ old('jam_selesai') }}"
                                class="w-full rounded-[10px] border py-[10px] pl-[38px] pr-[10px] text-[14px] text-gray-900 bg-gray-50 outline-none transition-all duration-200 focus:border-[#E8930A] focus:shadow-[0_0_0_3px_rgba(232,147,10,0.13)] focus:bg-white
                                {{ $errors->has('jam_selesai') && old('_modal') === 'create' ? 'border-red-300 bg-red-50' : 'border-gray-200' }}">
                        </div>
                        @if ($errors->has('jam_selesai') && old('_modal') === 'create')
                            <p class="flex items-center gap-1 text-xs text-red-600">
                                <svg class="w-3 h-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
