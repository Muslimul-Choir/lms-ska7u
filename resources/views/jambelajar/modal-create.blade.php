        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden
            ...
            <div class="flex items-center justify-between px-6 py-4
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        <h3 class="text-white font-semibold text-sm tracking-wide">Tambah Jam Belajar</h3>
                        <p class="text-blue-200 text-[11px]">Isi data jam belajar baru</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="time"
                           ...
                           class="w-full rounded-lg border px-3 py-2.5 text-sm text-slate-700
                                  ...
                                  transition
                                  @error('jam_mulai') border-red-400 bg-red-50 @else border-slate-200 @enderror">
                    @error('jam_mulai')
                ...
                <div>
                    ...
                    <input type="time"
                           ...
                           class="w-full rounded-lg border px-3 py-2.5 text-sm text-slate-700
                                  focus:outline-none focus:ring-2 focus:ring-[#1B3A6B]/30 focus:border-[#1B3A6B]
                                  transition
                                  @error('jam_selesai') border-red-400 bg-red-50 @else border-slate-200 @enderror">
                    @error('jam_selesai')
                        <p class="mt-1.5 flex items-center gap-1 text-xs text-red-500">
                            <svg class="w-3 h-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
