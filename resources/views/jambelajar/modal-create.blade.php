                ...
                <div>
                    ...
                    <div style="position:relative;">
                        ...
                        <select name="id_tingkatan"
                                style="width:100%; padding:10px 36px 10px 40px; border:1.5px solid {{ $errors->has('id_tingkatan') ? '#FCA5A5' : '#E5E7EB' }}; border-radius:10px; font-size:14px; color:#111827; background:{{ $errors->has('id_tingkatan') ? '#FEF2F2' : '#F9FAFB' }}; outline:none; box-sizing:border-box; transition:border-color .2s, box-shadow .2s; appearance:none; cursor:pointer;"
                            ...
                            @foreach($tingkatanList as $tingkatan)
                                <option value="{{ $tingkatan->id }}" {{ old('id_tingkatan') == $tingkatan->id ? 'selected' : '' }}>
