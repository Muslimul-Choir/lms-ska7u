            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm px-6 py-4">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-0.5 ml-3">Pilih tingkat dan kelas untuk menampilkan jadwal
                        </p>
                    </div>
                    @if ($isAdmin)
                        <div class="flex items-center gap-2">
                    ...
                    @else
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="inline-flex items-center gap-1.5 px-3 py-2 bg-blue-50 text-blue-600 text-xs font-semibold rounded-xl border border-blue-200">
                                👁️ Mode Lihat Saja
                            </span>
                        </div>
                    @endif
                    ...
                    <div class="flex flex-col items-center gap-3">
                        ...
                        <div
                            ...
                            <ol class="list-decimal list-inside space-y-1">
                                <li><strong>Guru Mapel</strong> - Assign guru ke mapel dan kelas (menentukan
                                    apa+siapa+di mana)</li>
                                <li><strong>Jadwal Belajar</strong> - Tentukan hari, jam, dan alokasi guru untuk setiap
                                    kelas (di sini)</li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    ...
                    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xs text-gray-400 mt-0.5 ml-3">Klik <span
                                    class="font-semibold text-amber-500">+</span> pada sel kosong untuk menambah jadwal
                            </p>
                        </div>
                    </div>
                                                            ...
                                                            <div
                                                                ...
                                                                @if ($isAdmin)
                                                                    ...
                                                                    <div class="flex items-center gap-1.5 mt-2">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('jadwalbelajar.destroy', $jadwal) }}"
                                                                            method="POST"
