    ...
    <div class="py-8 bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5">
            ...
            <nav class="flex items-center gap-1.5 text-xs text-slate-400 font-medium tracking-wide">
                ...
                <span class="text-slate-300">/</span>
                <a href="{{ route('jadwalbelajar.index') }}" class="hover:text-[#1B3A6B] transition">Jadwal Belajar</a>
                <span class="text-slate-300">/</span>
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                {{-- Card Header --}}
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-6 py-4 border-b border-slate-100 bg-gradient-to-r from-[#6B1A1A] to-[#B91C1C]">
                    <div>
                        <h3 class="text-white font-semibold text-sm tracking-wide">Data Jadwal Belajar Terhapus</h3>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            @forelse ($jadwals as $jadwal)
                                <tr class="hover:bg-red-50/40 transition group">
                                    ...
                                    {{-- Hari --}}
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-md border text-xs font-semibold bg-slate-100 text-slate-400 border-slate-200 line-through decoration-red-300">
                                            {{ $jadwal->hari }}
                                        </span>
                                    </td>
                                    ...
                                    {{-- Deleted At --}}
                                    <td class="px-6 py-4">
                                        <div class="inline-flex items-center gap-1.5 px-2 py-1 bg-red-50 border border-red-100 rounded-md">
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <p class="text-slate-300 text-xs">Tidak ada data jadwal belajar yang dihapus sementara</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
