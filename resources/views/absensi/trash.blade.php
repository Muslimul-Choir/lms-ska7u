    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-[11px] text-slate-400 mt-0.5 tracking-widest uppercase">Data Absensi Terhapus Sementara
                </p>
            </div>
        </div>
    </x-slot>
                        ...
                        <thead>
                            <tr class="bg-slate-50 border-b border-slate-200">
                                ...
                                <th
                                    ...
                                    Keterangan</th>
                                <th
                                    class="px-6 py-3 text-left text-[11px] font-bold text-slate-500 uppercase tracking-widest w-44">
                                    Dihapus Pada</th>
                                <th
                            ...
                            @forelse ($absensis as $absensi)
                                <tr class="hover:bg-red-50/40 transition group">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        @endphp
                                        <span
                                            class="inline-flex items-center px-2.5 py-1 {{ $bg }} {{ $text }} border {{ $border }} text-[10px] font-bold rounded-full uppercase tracking-wide opacity-70">
                                            {{ $label }}
                                        </span>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            {{-- Force Delete --}}
                                            <form action="{{ route('absensi.force-delete', $absensi->id) }}"
                                                method="POST"
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <p class="text-slate-300 text-xs">Tidak ada data absensi yang dihapus
                                                sementara</p>
                                        </div>
                                    </td>
                                </tr>
                ...
                @if ($absensis->hasPages())
                    <div
                        ...
                        <p class="text-xs text-slate-500">
                            Menampilkan
                            <span
                                class="font-semibold text-slate-700">{{ $absensis->firstItem() }}–{{ $absensis->lastItem() }}</span>
                            dari
