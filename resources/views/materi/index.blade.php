                                            ...
                                            @foreach ($materiList as $m)
                                                <tr class="hover:bg-amber-50/40 transition group">
                                                    ...
                                                    <td class="px-5 py-4 align-top">
                                                        ...
                                                        @endphp
                                                        <span
                                                            class="inline-flex items-center px-2.5 py-1 border rounded-full text-[10px] font-bold uppercase {{ $tipeColors }}">
                                                            {{ $m->tipe_materi }}
                                                        </span>
                                                    </td>
                                                    <td class="px-5 py-4 align-top">
                    ...
                    <div
                        ...
                        <form action="{{ route('materi.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="flex flex-col gap-[7px]">
                                ...
                                <p class="text-xs text-gray-500 italic">💡 Materi akan ditampilkan hanya untuk siswa di
            ...
            <div x-show="modalEditMateri" x-cloak x-transition
                ...
                <div class="relative z-10 w-full max-w-lg">
                    <div
                        ...
                        <form :action="'/materi/' + editMateriData.id" method="POST" enctype="multipart/form-data"
                            class="p-6 flex flex-col gap-[18px]">
                            @csrf
                            @method('PUT')
