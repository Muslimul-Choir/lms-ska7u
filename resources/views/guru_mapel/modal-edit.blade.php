        ...
        <div class="bg-white rounded-[18px] shadow-[0_24px_60px_rgba(107,26,43,0.22),0_4px_16px_rgba(0,0,0,0.08)] overflow-hidden border border-[rgba(107,26,43,0.1)]">
            ...
            <div class="px-6 py-[18px] flex items-center justify-between relative overflow-hidden"
                ...
                <div class="flex items-center gap-3 relative">
                    ...
                    <div>
                        <h3 class="text-white font-bold text-[15px] m-0 mb-[2px]">Edit Guru Mapel</h3>
                        <p class="text-[rgba(255,255,255,0.5)] text-[11px] m-0">Perbarui data penugasan guru ke mapel</p>
                    </div>
                </div>
            ...
            <form id="editFormAction" action="" method="POST" class="p-6 flex flex-col gap-[16px]">
                ...
                <div class="flex flex-col gap-[7px]">
                    ...
                    <select id="edit_id_mapel" name="id_mapel"
                        ...
                        {{ $errors->has('id_mapel') && old('_modal') === 'edit' ? 'border-red-300 bg-red-50' : 'border-gray-200' }}">
                ...
                <div class="flex flex-col gap-[7px]">
                    ...
                    <select id="edit_id_kelas" name="id_kelas"
                        ...
                        @forelse($kelas as $kls)
                            <option value="{{ $kls->id }}"
                                {{ old('id_kelas', '') == $kls->id && old('_modal') === 'edit' ? 'selected' : '' }}>
                ...
                <div class="flex flex-col gap-[7px]">
                    ...
                    <select id="edit_id_semester" name="id_semester"
                        class="w-full rounded-[10px] border py-[10px] px-[14px] text-[14px] text-gray-900 bg-gray-50 outline-none cursor-pointer transition-all duration-200 focus:border-[#E8930A] focus:shadow-[0_0_0_3px_rgba(232,147,10,0.13)] focus:bg-white
                        {{ $errors->has('id_semester') && old('_modal') === 'edit' ? 'border-red-300 bg-red-50' : 'border-gray-200' }}">
