                                ...
                                <tr class="hover:bg-amber-50/40 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span
                                                class="font-semibold text-gray-800 text-sm">{{ $guruMapel->Mapel->nama_mapel ?? '-' }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            <div
                                                class="w-7 h-7 rounded-full bg-gray-100 flex items-center justify-center flex-shrink-0">
                                                <span class="text-gray-500 text-[10px] font-bold uppercase">
                                                    {{ substr($guruMapel->Guru->nama_lengkap ?? '-', 0, 2) }}
                                                </span>
                                            </div>
                                            <span
                                                class="text-gray-700 text-sm font-medium">{{ $guruMapel->Guru->nama_lengkap ?? '-' }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        @if ($guruMapel->Semester->nama_semester ?? null)
                                            <span
                                                class="inline-flex items-center px-2.5 py-1 bg-amber-50 text-amber-700 border border-amber-200 text-xs font-semibold rounded-lg">
                ...
                @if ($guruMapels->hasPages())
                    <div class="px-6 py-4 border-t border-gray-100 bg-gray-50 flex items-center justify-between gap-4">
                        <p class="text-xs text-gray-500">
                            Menampilkan
                            <span
                                class="font-semibold text-gray-700">{{ $guruMapels->firstItem() }}–{{ $guruMapels->lastItem() }}</span>
                            dari
