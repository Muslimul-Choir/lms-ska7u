                                ...
                                <tr class="hover:bg-red-50/40 transition group">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            {{-- Restore --}}
                                            <form action="{{ route('guru_mapel.restore', $guruMapel->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit"
                                            ...
                                            {{-- Force Delete --}}
                                            <form action="{{ route('guru_mapel.forceDelete', $guruMapel->id) }}"
                                                method="POST"
                ...
                @if ($guruMapels->hasPages())
                    <div
                        ...
                        <p class="text-xs text-slate-500">
                            Menampilkan
                            <span
                                class="font-semibold text-slate-700">{{ $guruMapels->firstItem() }}–{{ $guruMapels->lastItem() }}</span>
                            dari
