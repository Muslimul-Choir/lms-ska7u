    ...
    <div style="position:relative; z-index:10; display:flex; align-items:center; justify-content:center; min-height:100vh; padding:1rem;">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-800">Tambah Tahun Ajaran</h3>
            ...
            <form action="{{ route('tahunajaran.store') }}" method="POST" class="px-6 py-5 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama_tahun" value="{{ old('nama_tahun') }}"
                           class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 @error('nama_tahun') border-red-400 @enderror"
