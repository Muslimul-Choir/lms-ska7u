<x-app-layout>
                    ...
                    <table class="min-w-full text-sm">
                        ...
                        <thead>
                            ...
                            <tr class="bg-gray-50 border-b border-gray-200">
                                ...
                                <th class="px-6 py-3 text-center text-[11px] font-bold text-gray-500 uppercase tracking-widest w-28">
                                    Status
                                </th>
                                ...
                                <tr class="hover:bg-amber-50/40 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            {{-- Delete --}}
                                            <form action="{{ route('tahunajaran.destroy', $tahun) }}"
                                                  method="POST"
                    ...
                    <div class="px-6 py-4 border-t border-gray-100 bg-gray-50 flex items-center justify-between gap-4">
                        ...
                        <p class="text-xs text-gray-500">
                            ...
                            <span class="font-semibold text-gray-700">
                                {{ $tahunAjarans->firstItem() }}–{{ $tahunAjarans->lastItem() }}
                            </span>
                            dari
                            <span class="font-semibold text-gray-700">
                                {{ $tahunAjarans->total() }}
    ...
    <script>
        ...
        document.getElementById('btnTambahTahun')
