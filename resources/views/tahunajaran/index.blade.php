                                ...
                                <tr class="hover:bg-amber-50/40 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span
                                                class="font-semibold text-gray-800 text-sm">{{ $tahun->nama_tahun }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-1.5">
                                            ...
                                            <button type="button" onclick="openEditModal(this)"
                                                ...
                                                data-is-aktif="{{ $tahun->is_aktif ? '1' : '0' }}" title="Edit"
                                            ...
                                            {{-- Delete --}}
                                            <form action="{{ route('tahunajaran.destroy', $tahun->id) }}"
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <p class="text-gray-400 text-sm font-semibold">Belum ada data tahun ajaran
                                            </p>
                                            <p class="text-gray-300 text-xs">Klik <span
                                                    class="font-semibold text-gray-400">+ Tambah Tahun</span> untuk
                                                mulai menambahkan</p>
                                            <button type="button" onclick="openCreateModal()"
        ...
        <script>
            ...
            btnSearch.addEventListener('click', () => {
                window.location.href =
                    `{{ route('tahunajaran.index') }}?search=${encodeURIComponent(searchInput.value)}`;
            });
