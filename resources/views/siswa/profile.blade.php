            ...
            <form action="{{ route('siswa.profil.password') }}" method="POST">
                ...
                <div style="margin-bottom:14px;">
                    ...
                    <input type="password" name="current_password" required
                        style="width:100%;padding:11px 14px;border:1.5px solid {{ $errors->has('current_password') ? '#fca5a5' : '#e2e8f0' }};border-radius:10px;font-size:14px;outline:none;background:#f8fafc;transition:border-color .2s;"
                ...
                <div style="margin-bottom:14px;">
                    ...
                    <input type="password" name="password" required
                        style="width:100%;padding:11px 14px;border:1.5px solid {{ $errors->has('password') ? '#fca5a5' : '#e2e8f0' }};border-radius:10px;font-size:14px;outline:none;background:#f8fafc;transition:border-color .2s;"
                        onfocus="this.style.borderColor='#6B1A2B';this.style.background='#fff'"
                        onblur="this.style.borderColor='#e2e8f0';this.style.background='#f8fafc'"
                ...
                <div style="margin-bottom:18px;">
                    ...
                    <input type="password" name="password_confirmation" required
                        style="width:100%;padding:11px 14px;border:1.5px solid #e2e8f0;border-radius:10px;font-size:14px;outline:none;background:#f8fafc;transition:border-color .2s;"
                        onfocus="this.style.borderColor='#6B1A2B';this.style.background='#fff'"
                        onblur="this.style.borderColor='#e2e8f0';this.style.background='#f8fafc'"
