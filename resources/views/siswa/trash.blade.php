                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($siswas as $index => $siswa)
                                <tr class="hover:bg-red-50/30 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <span
                                            class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold border opacity-60 bg-gray-100 text-gray-600 border-gray-200">
                                            {{ $siswa->agama ?? '-' }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span
                                            class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold border opacity-60 bg-sky-100 text-sky-700 border-sky-200">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <form action="{{ route('siswa.restore', $siswa->id) }}" method="POST">
                                                @csrf
                                                @method('PATCH')
                                                <button type="button" onclick="confirmRestoreSiswa(event)"
                                            ...
                                            {{-- Force Delete --}}
                                            <form action="{{ route('siswa.forceDelete', $siswa->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" onclick="confirmForceDeleteSiswa(event)"
                                ...
                                <tr>
                                    <td colspan="8" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            @else
                                                <p class="text-gray-300 text-xs">Tidak ada siswa yang dihapus sementara
                                                </p>
                                            @endif
                                        </div>
                                    </td>
