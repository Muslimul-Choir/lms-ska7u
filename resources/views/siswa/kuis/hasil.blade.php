    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="flex items-start gap-3 p-4 rounded-xl bg-blue-50 border border-blue-200">
            ...
            <div class="flex-1 text-xs text-gray-700 space-y-1">
                <div><strong class="text-gray-900">Mulai:</strong> {{ $hasilKuis->waktu_mulai->format('d M Y, H:i:s') }}</div>
                <div><strong class="text-gray-900">Selesai:</strong> {{ $hasilKuis->waktu_selesai->format('d M Y, H:i:s') }}</div>
