        ...
        <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <a href="{{ route('siswa.trash') }}"
                    ...
                    🗑 Trash
                    @if($trashCount > 0)
                        <span class="bg-red-500 text-white text-xs rounded-full px-1.5 py-0.5">{{ $trashCount }}</span>
                    @endif
                </a>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <form action="{{ route('siswa.destroy', $siswa->id) }}" method="POST"
                                        onsubmit="return confirm('Hapus data siswa {{ addslashes($siswa->nama_lengkap) }}?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
