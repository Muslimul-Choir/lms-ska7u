                            ...
                            @forelse ($gurus as $index => $guru)
                                <tr class="hover:bg-red-50/30 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @endphp
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold border opacity-60 {{ $badgeClass }}">
                                            {{ $badgeLabel }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <form action="{{ route('guru.forceDelete', $guru->id) }}" method="POST">
                                                ...
                                                @method('DELETE')
                                                <button type="button"
                                                    onclick="confirmForceDelete(event)"
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            @if (request()->hasAny(['search', 'status_pengajar']))
                                                <a href="{{ route('guru.trash') }}" class="text-xs text-amber-500 hover:text-amber-600 transition">Reset filter</a>
                                            @else
                                                <p class="text-gray-300 text-xs">Tidak ada guru yang dihapus sementara</p>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
