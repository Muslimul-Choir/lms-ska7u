            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="text-gray-400 text-xs mt-0.5">Kelola data pertemuan tiap jadwal belajar</p>
                    </div>
                                ...
                                @forelse ($pertemuans as $pertemuan)
                                    <tr class="hover:bg-amber-50/40 transition">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            ...
                                            @endphp
                                            <span class="inline-flex items-center px-2.5 py-1 border rounded-full text-[10px] font-bold {{ $statusMap[$pertemuan->status] ?? 'bg-gray-100 text-gray-500 border-gray-200' }}">
    ...
    @push('scripts')
        <script>
            ...
            function getSearchUrl() {
                ...
                if (jadwalSelect.value)         params.append('id_jadwal',  jadwalSelect.value);
            ...
            jadwalSelect.addEventListener('change', () => window.location.href = getSearchUrl());
