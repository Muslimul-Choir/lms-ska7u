                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-16">
                                        <div class="flex flex-col items-center justify-center text-center gap-3">
                                            ...
                                            <div>
                                                <p class="text-blue-600 text-sm font-semibold">Belum Ada Jadwal yang
                                                    Ditugaskan</p>
                                                <p class="text-blue-400 text-xs max-w-xs mt-1">Anda belum diassign ke
                                                    mapel apapun. Hubungi administrator untuk diassign mengajar di
                                                    kelas-kelas tertentu.</p>
                                                <div
                                                    class="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg text-left text-xs text-blue-700 max-w-xs">
                                                    <p class="font-semibold mb-1">📋 Langkah untuk administrator:</p>
                                                    <p>Buka menu <strong>Guru Mapel</strong>, lalu tambahkan guru ini.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                @forelse ($pertemuans as $pertemuan)
                                    <tr class="hover:bg-amber-50/40 transition">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            ...
                                            <span
                                                class="inline-flex items-center px-2.5 py-1 border rounded-full text-[10px] font-bold {{ $statusMap[$pertemuan->status] ?? '' }}">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-status="{{ $pertemuan->status }}" title="Edit">
