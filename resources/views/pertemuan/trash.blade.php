                                ...
                                <tr class="hover:bg-red-50/40 transition group">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        @php
                                            ...
                                            [$bg, $color, $border, $label] = $statusMap[$pertemuan->status] ?? ['#F9FAFB','#9CA3AF','#E5E7EB',$pertemuan->status];
                                        @endphp
                                        <span style="display:inline-flex; align-items:center; padding:3px 10px; background:{{ $bg }}; color:{{ $color }}; border:1px solid {{ $border }}; font-size:10px; font-weight:700; border-radius:99px; opacity:.8;">
                                            {{ $label }}
                                        </span>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <p class="text-slate-300 text-xs">Tidak ada data pertemuan yang dihapus sementara</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
