    ...
    <style>
        ...
        *::after {
        ...
        @keyframes iconPulse {
            ...
            0%,
            100% {
                box-shadow: 0 0 0 0 rgba(232, 147, 10, 0.15);
            }

            50% {
                box-shadow: 0 0 0 10px rgba(232, 147, 10, 0);
            }
        }
            ...
            <div class="card-content">
                ...
                <div class="email-icon-wrap f1">
                    <div class="email-icon-bg">
                        <svg width="28" height="28" fill="none" viewBox="0 0 24 24" stroke="#E8930A"
                            stroke-width="1.8">
                ...
                <p class="form-sub f2">
                    ...
                    tautan yang telah kami kirimkan. Jika tidak menerima email, kami dapat mengirimkan yang baru.
                </p>
