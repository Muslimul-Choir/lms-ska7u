...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-sub {
            font-size: 12.5px; color: #9a8880; margin-bottom: 20px;
            line-height: 1.65;
        }
        ...
        .strength-bar-wrap {
            ...
            background: #ecddd4; margin-top: 6px; overflow: hidden;
        }
        .strength-bar {
        ...
        .strength-hint {
            font-size: 11px; color: #c8b4a8; margin-top: 3px;
        }
...
<body>
                ...
                <form method="POST" action="{{ route('password.store') }}" id="reset-form">
                    ...
                    <div class="field f4">
                        ...
                        <div class="input-wrap">
                            ...
                            <button type="button" class="pw-toggle" onclick="togglePw('password','eye-show-1','eye-hide-1')">
                                <svg id="eye-show-1" style="display:block;width:15px;height:15px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                                <svg id="eye-hide-1" style="display:none;width:15px;height:15px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="field f5">
                        ...
                        <div class="input-wrap">
                            ...
                            <input id="password_confirmation" type="password" name="password_confirmation"
                                   ...
                                   style="padding-right:36px"
                                   oninput="checkMatch()">
                            <button type="button" class="pw-toggle" onclick="togglePw('password_confirmation','eye-show-2','eye-hide-2')">
                                <svg id="eye-show-2" style="display:block;width:15px;height:15px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                                <svg id="eye-hide-2" style="display:none;width:15px;height:15px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/>
                                </svg>
                            </button>
                        </div>
    ...
    <script>
        ...
        function togglePw(inputId, showId, hideId) {
            ...
            if (pw.type === 'password') {
                pw.type = 'text'; s.style.display = 'none'; h.style.display = 'block';
            } else {
                pw.type = 'password'; s.style.display = 'block'; h.style.display = 'none';
            }
        }
        ...
        function checkStrength(val) {
            ...
            const levels = [
                { w: '20%', color: '#e05555', text: 'Sangat lemah' },
                { w: '40%', color: '#E8930A', text: 'Lemah' },
                { w: '60%', color: '#f0b429', text: 'Cukup' },
                { w: '80%', color: '#6B1A2B', text: 'Kuat' },
                { w: '100%', color: '#2d7a3a', text: 'Sangat kuat' },
            ];
