    ...
    <style>
        ...
        *::after {
        ...
        .alert {
            ...
            border: 1px solid rgba(232, 147, 10, 0.28);
            color: #8a5000;
        }
        ...
        .remember-label input[type="checkbox"]:checked {
            background: linear-gradient(135deg, #E8930A, #F5A623);
            border-color: #E8930A;
        }
        ...
        .btn-submit:disabled {
            cursor: not-allowed;
            background: linear-gradient(135deg, #4a0f1e, #6b1a2b);
...
<body>
        ...
        <div class="book">
            <div class="pages" style="position:relative;">
                ...
                <div class="left-page">
                    ...
                    <img class="left-img" src="https://images.unsplash.com/photo-1580582932707-520aed937b7b?w=700&q=75"
                        alt="">
                    ...
                    <div class="left-content">
                        <div>
                            ...
                            <p class="left-sub">Mendukung proses pembelajaran dan pengelolaan akademik dalam satu
                                platform yang terintegrasi.</p>
                ...
                <div class="right-page">
                    ...
                    <div class="right-content">
                        ...
                        {{-- MODIFIKASI DISINI: Menambahkan id="loginForm" pada tag form --}}
                        <form id="loginForm" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="field f4">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <button type="button" class="pw-toggle" onclick="togglePw()">
                                        <svg id="eye-show" style="display:block;width:15px;height:15px;"
                                        ...
                                        <svg id="eye-hide" style="display:none;width:15px;height:15px;"
                                            fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                            stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            {{-- Submit --}}
                            {{-- MODIFIKASI DISINI: Menambahkan id="submitBtn" --}}
                            <button type="submit" id="submitBtn" class="btn-submit f6">
    ...
    <script>
        // Fungsi lama untuk Toggle Password
        function togglePw() {
        ...
        // FUNGSI BARU: Mencegah Double Click saat submit form
        document.getElementById('loginForm').addEventListener('submit', function (e) {
            const btn = document.getElementById('submitBtn');
            
            // Nonaktifkan tombol segera setelah form valid & terkirim
            btn.disabled = true;
            
            // Opsional: Mengubah teks tombol agar memberikan feedback visual proses loading
            btn.innerHTML = `
    ...
    {{-- Opsional style untuk animasi putar icon memverifikasi (jika ingin digunakan) --}}
    <style>
        @keyframes spin {
