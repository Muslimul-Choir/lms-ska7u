                ...
                <div
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ route('users.trash') }}"
                            ...
                            @if ($trashCount > 0)
                                <span
                                    class="bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full font-bold leading-none">
                                    {{ $trashCount }}
                                </span>
                            @endif
                        </a>
                                ...
                                <tr class="hover:bg-amber-50/40 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span
                                                class="font-semibold text-gray-800 text-sm">{{ $user->name }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            {{-- Edit --}}
                                            <button type="button" onclick="openEditUserModal(this)"
                                                data-id="{{ $user->id }}"
                                    ...
                                    <td colspan="5" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <p class="text-gray-300 text-xs">Klik <span
                                                    class="font-semibold text-gray-400">+ Tambah Akun</span> untuk
                                                mulai menambahkan</p>
                                        </div>
                                    </td>
                                </tr>
