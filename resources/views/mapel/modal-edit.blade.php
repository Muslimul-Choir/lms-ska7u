        ...
        <div class="bg-white rounded-[18px] shadow-[0_24px_60px_rgba(107,26,43,0.22),0_4px_16px_rgba(0,0,0,0.08)] overflow-hidden border border-[rgba(107,26,43,0.1)]">
            ...
            <div class="px-6 py-[18px] flex items-center justify-between relative overflow-hidden"
                ...
                <div class="flex items-center gap-3 relative">
                    ...
                    <div>
                        <h3 class="text-white font-bold text-[15px] m-0 mb-[2px]">Edit Mapel</h3>
                        <p class="text-[rgba(255,255,255,0.5)] text-[11px] m-0">Perbarui data mata pelajaran</p>
                    </div>
                </div>
            ...
            <form id="editFormAction" action="" method="POST"
                ...
                <div class="flex flex-col gap-[7px]">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="editKodeMapel" name="kode_mapel"
                            ...
                            {{ $errors->has('kode_mapel') && old('_modal') === 'edit' ? 'border-red-300 bg-red-50' : 'border-gray-200' }}">
                    </div>
                    @if ($errors->has('kode_mapel') && old('_modal') === 'edit')
                ...
                <div class="flex flex-col gap-[7px]">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="editNamaMapel" name="nama_mapel"
                            ...
                            class="w-full rounded-[10px] border py-[10px] pl-[40px] pr-[14px] text-[14px] text-gray-900 bg-gray-50 outline-none transition-all duration-200 focus:border-[#E8930A] focus:shadow-[0_0_0_3px_rgba(232,147,10,0.13)] focus:bg-white
                            {{ $errors->has('nama_mapel') && old('_modal') === 'edit' ? 'border-red-300 bg-red-50' : 'border-gray-200' }}">
                    </div>
                    @if ($errors->has('nama_mapel') && old('_modal') === 'edit')
                        <p class="flex items-center gap-1 text-xs text-red-600">
                            <svg class="w-3 h-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                ...
                <div class="flex flex-col gap-[7px]">
                    ...
                    <textarea id="editDeskripsi" name="deskripsi" rows="3"
                        ...
                        {{ $errors->has('deskripsi') && old('_modal') === 'edit' ? 'border-red-300 bg-red-50' : 'border-gray-200' }}"></textarea>
                    @if ($errors->has('deskripsi') && old('_modal') === 'edit')
                        <p class="flex items-center gap-1 text-xs text-red-600">
                            <svg class="w-3 h-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                ...
                <div class="flex flex-col gap-[7px]">
                    ...
                    <div id="editFotoPreviewWrap" class="hidden mb-2">
                        <img id="editFotoPreview" src="" alt="Foto Mapel"
                            class="w-20 h-20 object-cover rounded-[10px] border-2 border-gray-200">
                        <p class="text-[11px] text-gray-400 mt-1">Foto saat ini</p>
                    </div>
                    ...
                    <div class="border-[1.5px] border-dashed border-gray-200 hover:border-[#E8930A] rounded-[10px] px-4 py-[14px] bg-gray-50 flex items-center gap-3 transition-all duration-200">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-[11px] text-gray-400 mt-[3px]">Format: JPG, PNG, GIF. Maks 2MB. Kosongkan jika tidak ingin mengubah.</p>
                        </div>
                    </div>
                    @if ($errors->has('foto') && old('_modal') === 'edit')
                        <p class="flex items-center gap-1 text-xs text-red-600">
                            <svg class="w-3 h-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                            {{ $errors->first('foto') }}
                        </p>
