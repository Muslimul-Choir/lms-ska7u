<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="font-bold text-[15px] text-gray-800 tracking-wide leading-none">Tempat Sampah — Bagian</h2>
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <p class="text-gray-300 text-xs">Tidak ada data yang dihapus sementara</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
