                                ...
                                <tr class="hover:bg-amber-50/40 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span
                                                class="font-semibold text-gray-800 text-sm">{{ $bagian->nama_bagian }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-1.5">
                                            ...
                                            <button type="button" onclick="openEditModal(this)"
                                                ...
                                                data-deskripsi="{{ $bagian->deskripsi ?? '' }}" title="Edit"
                                    ...
                                    <td colspan="4" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <p class="text-gray-300 text-xs">Klik <span
                                                    class="font-semibold text-gray-400">+ Tambah Bagian</span> untuk
                                                mulai menambahkan</p>
                                            <button type="button" onclick="openCreateModal()"
