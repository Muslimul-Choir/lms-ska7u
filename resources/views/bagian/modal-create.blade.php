        ...
        <div style="background:#fff; border-radius:18px; box-shadow:0 24px 60px rgba(107,26,43,0.22), 0 4px 16px rgba(0,0,0,0.08); overflow:hidden; border:1px solid rgba(107,26,43,0.1);">
            ...
            <div style="padding:18px 24px; background:linear-gradient(135deg,#6B1A2B 0%,#4A0F1E 55%,#2D0810 100%); display:flex; align-items:center; justify-content:space-between; position:relative; overflow:hidden;">
                ...
                <div style="display:flex; align-items:center; gap:12px; position:relative;">
                    ...
                    <div>
                        <h3 style="color:#fff; font-weight:700; font-size:15px; margin:0 0 2px;">Tambah Bagian Baru</h3>
                        <p style="color:rgba(255,255,255,0.5); font-size:11px; margin:0;">Isi informasi unit / divisi</p>
                    </div>
                </div>
            ...
            {{-- ── Body ── --}}
            <form action="{{ route('bagian.store') }}" method="POST" style="padding:24px; display:flex; flex-direction:column; gap:18px;">
                @csrf
                ...
                <div>
                    ...
                    <div style="position:relative;">
                        ...
                        <input type="text"
                               ...
                               style="width:100%; padding:10px 14px 10px 40px; border:1.5px solid {{ $errors->has('nama_bagian') ? '#FCA5A5' : '#E5E7EB' }}; border-radius:10px; font-size:14px; color:#111827; background:{{ $errors->has('nama_bagian') ? '#FEF2F2' : '#F9FAFB' }}; outline:none; box-sizing:border-box; transition:border-color .2s, box-shadow .2s;"
