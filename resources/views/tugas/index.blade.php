<x-app-layout>
    ...
    <div class="bg-gray-50 min-h-screen">
                                            ...
                                            @foreach ($tugasList as $t)
                                                <tr class="hover:bg-amber-50/40 transition group">
                                                    ...
                                                    <td class="px-5 py-4 align-top">
                                                        ...
                                                        @if ($t->deskripsi)
                                                            <div class="text-xs text-gray-500 mt-1">{{ Str::limit($t->deskripsi, 60) }}</div>
                                                        @endif
                                                    </td>
                                                    <td class="px-5 py-4 align-top">
                                                    ...
                                                    <td class="px-5 py-4 align-top">
                                                        <div class="text-xs text-gray-700">{{ \Carbon\Carbon::parse($t->batas_waktu)->format('d M Y') }}</div>
                                                        <div class="text-[10px] text-gray-500">{{ \Carbon\Carbon::parse($t->batas_waktu)->format('H:i') }}</div>
                                                    </td>
                                                    <td class="px-5 py-4 align-top">
                                                        ...
                                                        @elseif ($t->status === 'closed')
                                                            <span class="inline-flex items-center px-2.5 py-1 border rounded-full text-[10px] font-bold bg-red-50 text-red-700 border-red-200">Closed</span>
                                                        @else
        ...
        {{-- Overlay --}}
        <div @click="modalTugas = false" class="absolute inset-0 bg-[rgba(45,8,16,0.55)] backdrop-blur-[4px]"></div>
        ...
        <div class="relative z-10 w-full max-w-lg max-h-[90vh] overflow-y-auto">
            <div class="bg-white rounded-[18px] shadow-[0_24px_60px_rgba(107,26,43,0.22),0_4px_16px_rgba(0,0,0,0.08)] overflow-hidden border border-[rgba(107,26,43,0.1)]">
                ...
                {{-- Body --}}
                <form action="{{ route('tugas.store') }}" method="POST" enctype="multipart/form-data" class="p-6 flex flex-col gap-[18px]">
                    @csrf
                    ...
                    <div class="flex flex-col gap-[7px]">
                        ...
                        <p class="text-xs text-gray-500 italic">💡 Tugas akan ditampilkan hanya untuk siswa di kelas yang dipilih</p>
                    </div>
                    ...
                    <div class="flex flex-col gap-[7px]">
                        ...
                        <input type="text" name="judul" required placeholder="Contoh: Analisis Struktur Data"
                    ...
                    <div x-show="tipeFile !== 'tanpa' && tipeFile !== 'link'" class="flex flex-col gap-[7px]">
                        ...
                        <input type="file" name="file_url" :required="tipeFile !== 'tanpa' && tipeFile !== 'link'"
                            class="w-full rounded-[10px] border border-gray-200 py-[10px] px-[14px] text-[14px] text-gray-900 bg-gray-50 outline-none transition-all duration-200 focus:border-[#E8930A] focus:shadow-[0_0_0_3px_rgba(232,147,10,0.13)] focus:bg-white">
                    ...
                    <div x-show="tipeFile === 'link'" class="flex flex-col gap-[7px]">
                        ...
                        <input type="url" name="file_url" :required="tipeFile === 'link'" placeholder="https://..."
                            class="w-full rounded-[10px] border border-gray-200 py-[10px] px-[14px] text-[14px] text-gray-900 bg-gray-50 outline-none transition-all duration-200 focus:border-[#E8930A] focus:shadow-[0_0_0_3px_rgba(232,147,10,0.13)] focus:bg-white">
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="flex flex-col gap-[7px]">
                            ...
                            <input type="number" name="nilai_maksimal" value="100" required min="1" max="1000"
                                class="w-full rounded-[10px] border border-gray-200 py-[10px] px-[14px] text-[14px] text-gray-900 bg-gray-50 outline-none transition-all duration-200 focus:border-[#E8930A] focus:shadow-[0_0_0_3px_rgba(232,147,10,0.13)] focus:bg-white">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <label for="allow_late" class="text-sm text-gray-700">Izinkan pengumpulan terlambat</label>
                    </div>
    ...
    <div x-show="modalEditTugas" x-cloak x-transition
        ...
        <div @click="modalEditTugas = false" class="absolute inset-0 bg-[rgba(45,8,16,0.55)] backdrop-blur-[4px]"></div>
        ...
        <div class="relative z-10 w-full max-w-lg max-h-[90vh] overflow-y-auto">
            <div class="bg-white rounded-[18px] shadow-[0_24px_60px_rgba(107,26,43,0.22),0_4px_16px_rgba(0,0,0,0.08)] overflow-hidden border border-[rgba(107,26,43,0.1)]">
                ...
                <form :action="'/tugas/' + editTugasData.id" method="POST" enctype="multipart/form-data" class="p-6 flex flex-col gap-[18px]">
                    @csrf
                    @method('PUT')
                    ...
                    <div x-show="tipeFileEdit !== 'tanpa' && tipeFileEdit !== 'link'" class="flex flex-col gap-[7px]">
                        <label class="text-[11.5px] font-bold text-gray-500 uppercase tracking-[0.55px]">
                            File Lampiran <span class="text-gray-400 font-normal normal-case tracking-normal">(opsional - kosongkan jika tidak ingin mengubah)</span>
                        </label>
                        <input type="file" name="file_url"
                            class="w-full rounded-[10px] border border-gray-200 py-[10px] px-[14px] text-[14px] text-gray-900 bg-gray-50 outline-none transition-all duration-200 focus:border-[#E8930A] focus:shadow-[0_0_0_3px_rgba(232,147,10,0.13)] focus:bg-white">
                        <p class="text-xs text-gray-500">File saat ini: <span x-text="editTugasData.file_url ? editTugasData.file_url.split('/').pop() : 'Tidak ada'"></span></p>
                    </div>
                    ...
                    <div x-show="tipeFileEdit === 'link'" class="flex flex-col gap-[7px]">
                        ...
                        <input type="url" name="file_url" x-model="editTugasData.file_url" :required="tipeFileEdit === 'link'"
                            class="w-full rounded-[10px] border border-gray-200 py-[10px] px-[14px] text-[14px] text-gray-900 bg-gray-50 outline-none transition-all duration-200 focus:border-[#E8930A] focus:shadow-[0_0_0_3px_rgba(232,147,10,0.13)] focus:bg-white">
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="flex flex-col gap-[7px]">
                            ...
                            <input type="datetime-local" name="batas_waktu" x-model="editTugasData.batas_waktu" required
                                class="w-full rounded-[10px] border border-gray-200 py-[10px] px-[14px] text-[14px] text-gray-900 bg-gray-50 outline-none transition-all duration-200 focus:border-[#E8930A] focus:shadow-[0_0_0_3px_rgba(232,147,10,0.13)] focus:bg-white">
                        </div>
                        ...
                        <div class="flex flex-col gap-[7px]">
                            ...
                            <input type="number" name="nilai_maksimal" x-model="editTugasData.nilai_maksimal" required min="1" max="1000"
                                class="w-full rounded-[10px] border border-gray-200 py-[10px] px-[14px] text-[14px] text-gray-900 bg-gray-50 outline-none transition-all duration-200 focus:border-[#E8930A] focus:shadow-[0_0_0_3px_rgba(232,147,10,0.13)] focus:bg-white">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        <input type="checkbox" name="allow_late" value="1" x-model="editTugasData.allow_late"
                            class="w-4 h-4 rounded border-gray-300 text-amber-600 focus:ring-amber-500">
