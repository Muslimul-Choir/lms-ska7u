                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            @else
                                                <p class="text-gray-300 text-xs">Tidak ada kelas yang dihapus sementara
                                                </p>
                                            @endif
                                        </div>
                                    </td>
                ...
                @if ($kelasTrashed->hasPages())
                    <div class="px-6 py-4 border-t border-gray-100 bg-gray-50 flex items-center justify-between gap-4">
                        <p class="text-xs text-gray-500">
                            Menampilkan
                            <span
                                class="font-semibold text-gray-700">{{ $kelasTrashed->firstItem() }}–{{ $kelasTrashed->lastItem() }}</span>
                            dari
