<x-app-layout>
                ...
                <form method="GET" action="{{ route('kelas.index') }}" id="filterForm">
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-end lg:flex-wrap">
                        ...
                        <div class="flex-1 min-w-[200px]">
                            <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Cari Kelas</label>
                            <div class="relative">
                        ...
                        <div class="min-w-[140px]">
                            <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Tingkatan</label>
                        ...
                        {{-- Filter Jurusan --}}
                        <div class="min-w-[160px]">
                            <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Jurusan</label>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 w-28">Aksi</th>
                            </tr>
                        </thead>
    ...
    <script>
        ...
        async function openEditModal(id) {
            try {
                const res = await fetch(`/kelas/${id}/edit`, {
                    headers: {
                ...
                document.getElementById('editFormAction').action = `/kelas/${id}`;
                // Simpan id ke hidden field agar tersedia saat reopen dari error validasi
                document.getElementById('edit_id').value = id;
                document.getElementById('edit_id_tingkatan').value   = data.id_tingkatan;
                document.getElementById('edit_id_jurusan').value     = data.id_jurusan;
                document.getElementById('edit_id_bagian').value      = data.id_bagian;
                document.getElementById('edit_id_tahun_ajaran').value= data.id_tahun_ajaran;
