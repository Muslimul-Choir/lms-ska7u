                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <button type="button" onclick="openEditModal(this)"
                                                data-id="{{ $kelas->id }}"
                                                data-id-tingkatan="{{ $kelas->id_tingkatan }}"
                                                data-id-jurusan="{{ $kelas->id_jurusan }}"
                                                data-id-bagian="{{ $kelas->id_bagian }}"
                                                data-id-tahun-ajaran="{{ $kelas->id_tahun_ajaran }}"
                                                data-id-wali-kelas="{{ $kelas->id_wali_kelas }}" title="Edit"
