        ...
        <div class="relative w-full max-w-lg rounded-2xl bg-white shadow-xl dark:bg-gray-800 transition-all">
            ...
            <form action="{{ route('kelas.store') }}" method="POST" novalidate>
                ...
                <div class="space-y-4 px-6 py-5">
                    ...
                    {{-- Tingkatan --}}
                    <div>
                        <label for="create_id_tingkatan" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    {{-- Jurusan --}}
                    <div>
                        <label for="create_id_jurusan" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    {{-- Bagian --}}
                    <div>
                        <label for="create_id_bagian" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    {{-- Tahun Ajaran --}}
                    <div>
                        <label for="create_id_tahun_ajaran" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        ...
                        <select id="create_id_tahun_ajaran" name="id_tahun_ajaran"
                            ...
                            @foreach ($tahunAjaranList as $item)
                                <option value="{{ $item->id }}"
                                    {{ (old('id_tahun_ajaran') == $item->id && old('_modal') === 'create') ? 'selected' : ($item->is_aktif ? 'selected' : '') }}>
                    ...
                    {{-- Wali Kelas --}}
                    <div>
                        <label for="create_id_wali_kelas" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
