@php
    $editAction = old('_modal') === 'edit' && old('edit_id') ? route('kelas.update', old('edit_id')) : '';
@endphp

<div id="modalEdit" class="hidden fixed inset-0 z-[9999]">
    ...
    {{-- Dialog --}}
    <div
        style="position:relative; z-index:10; display:flex; align-items:center; justify-content:center; min-height:100vh; padding:1rem;">
