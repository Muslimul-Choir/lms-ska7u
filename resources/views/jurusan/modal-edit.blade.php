            ...
            <form id="formEdit" action="" method="POST" class="px-6 py-5 space-y-4">
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           class="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm text-slate-700
                                  placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-[#C8992A]/30
                ...
                <div>
                    ...
                    <textarea id="editKeterangan"
                              ...
                              class="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm text-slate-700
                                     placeholder-slate-300 resize-none focus:outline-none focus:ring-2
                                     focus:ring-[#C8992A]/30 focus:border-[#C8992A] transition"></textarea>
                </div>
